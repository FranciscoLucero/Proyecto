...
public class Menu_Principal extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_alumnos) {
            fragmentManager.beginTransaction().replace(R.id.Contenedor, new AlumnosFragment()).commit();
        } else if (id == R.id.nav_docentes) {
            fragmentManager.beginTransaction().replace(R.id.Contenedor, new DocentesFragment()).commit();
        } else if (id == R.id.nav_lista) {
            fragmentManager.beginTransaction().replace(R.id.Contenedor, new ListasFragment()).commit();
